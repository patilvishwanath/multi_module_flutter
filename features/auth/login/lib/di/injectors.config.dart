...
import 'package:login/presentation/bloc/login_bloc.dart' as _i108;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i762.LoginService>(
      () => _i762.LoginService(gh<_i361.Dio>(), gh<_i437.AppEnvConfig>()),
    );
    ...
    gh.factory<_i108.LoginBloc>(
      () => _i108.LoginBloc(loginUseCase: gh<_i824.LoginUseCase>()),
    );
    return this;
  }
}
